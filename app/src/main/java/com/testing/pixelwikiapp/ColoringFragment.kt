...
import com.testing.pixelwikiapp.databinding.FragmentColoringBinding
...
class ColoringFragment : Fragment() {
    ...
    lateinit var binding: FragmentColoringBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentColoringBinding.inflate(inflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.backButton1.setOnClickListener {
            Navigation.findNavController(binding.root).navigate(R.id.to_menu3)
        }
    ...
    fun getNewResponse() {
        ...
        postService.getById(14).enqueue(object: Callback<PostResponse> { // call random post number
